const en = {
  ...
  systemTitle: 'after dark is sunrise',
  archives: 'Archives',
  total: 'Total',
  ...
  protectedArticleMsg: 'The article is protected, please enter the access password',
  ...
  commentNamespace: {
    reply: 'Reply',
    emoji: 'Emoji',
    replyPlaceholder: 'Please enter the content of the comment (Markdown is supported)',
    publish: 'Send',
    close: 'Close',
    commentSuccess: 'The comment is successful and has been submitted for review',
  ...
  shareNamespace: {
    title: 'Share Poster',
    createingPoster: 'The poster is being generated, please be patient...',
  ...
  tagTitle: 'Tags',
  toc: 'Toc',
  'menus.working': 'working',
  'menus.file': 'file',
  'menus.file.index': 'fileList',
  'menus.news': 'news',
  ...
  'table.setting': 'columns setting',
  'density.default': 'default',
  'density.middle': 'middle',
  'density.small': 'small'
}
export default en
