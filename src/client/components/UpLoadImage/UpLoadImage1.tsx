...
export default class ShowImg extends Component {
  constructor(props) {
    super(props)
    this.state = { f: this.props.firstIndex, R: 0, S: 1, i: 0, SS: 1, data: this.props.data, showimgs: this.props.showimgs }
  }
  componentDidMount() {}
          ...
          <div>
            ...
            <div className="bigimg toggleshow">
              ...
              <p className="showbig" onClick={this.showbig}>
                <i className="icon icon-imgbig" style={{ fontSize: '30px' }}></i>
              </p>
              <p className="showmin" onClick={this.showmin}>
                <i className="icon icon-imgmin" style={{ fontSize: '30px' }}></i>
              </p>
            </div>
          </div>
        ) : null}
